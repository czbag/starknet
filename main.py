...
def get_module():
    result = questionary.select(
        ...
        choices=[
            ...
            Choice("11) Deposit Nostra", deposit_nostra),
            Choice("12) Withdraw ZkLend", withdraw_zklend),
            Choice("13) Withdraw Nostra", withdraw_nostra),
            Choice("14) Enable collateral ZkLend", enable_collateral_zklend),
            Choice("15) Disable collateral ZkLend", disable_collateral_zklend),
            Choice("16) Mint Starknet ID", mint_starknet_id),
            Choice("17) Dmail send mail", send_mail_dmail),
            Choice("18) Mint StarkStars NFT", mint_starkstars),
            Choice("19) Mint StarkVerse NFT", mint_starkverse),
