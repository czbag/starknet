...
def get_module():
    result = questionary.select(
        ...
        choices=[
            ...
            Choice("22) Mint Starkverse NFT", mint_starkverse),
            Choice("23) Unframed", cancel_order_unframed),
            Choice("24) Flex", cancel_order_flex),
            Choice("25) Mint Gol token", mint_gol),
            Choice("26) Approve almanac NFT", approve_almanac),
            Choice("27) Approve ninth token", approve_ninth),
            Choice("28) Deploy token", deploy_token),
            Choice("29) Deploy and mint NFT", deploy_nft),
            Choice("30) Transfer", make_transfer),
